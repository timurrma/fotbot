...
- `weekly` — 5 карточек (65-74: 55%, 75-84: 35%, 85+: 10%)
- `special` — 5 карточек (65-74: 30%, 75-84: 35%, 85+: 35%)
- `russia` — 1 русский игрок (65-74: 68%, 75-78: 25%, 79+: 7%) + 1% Аршавин
- `brazil` — 2 бразильца (65-74: 68%, 75-79: 23%, 80-84: 7%, 85+: 2%)
- `turkey` — 1 турок (65-74: 68%, 75-78: 25%, 79+: 7%)
- `saudi` — 1 игрок Саудовской лиги (65-74: 68%, 75-78: 25%, 79+: 7%)
- `minirandom` — рандомно один из: russia / brazil / turkey / saudi
- `morning` — 2 карточки, утренний (<70: 85%, 70-75: 10%, 76-80: 4.5%, 80+: 0.5%)
- `record` — 3 карточки, награда за рекорд (65-74: 75%, 75-84: 20%, 85+: 5%)
