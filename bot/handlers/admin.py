...
PACK_MENU = [
    ...
    ("spain",     "🇪🇸 Испания",         "2 испанца"),
    ("germany",   "🇩🇪 Германия",        "2 немца"),
    ("turkey",    "🇹🇷 Турция",          "2 турка (1% Арда Туран)"),
    ("saudi",     "🇸🇦 Саудовская лига", "2 игрока Saudi Pro League"),
    ("minirandom","мини-рандом",          "рандомно: russia/brazil/spain/germany/france/england/turkey/saudi"),
...
async def cmd_givepack(message: Message) -> None:
    ...
    if pack_type == "minirandom":
        ...
        pack_type = _random.choice(["russia", "brazil", "spain", "germany", "france", "england", "turkey", "saudi"])
